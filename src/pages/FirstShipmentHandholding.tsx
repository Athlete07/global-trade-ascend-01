          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 max-w-md mx-auto">
              <div className="text-center">
                <div className="text-3xl font-bold text-blue-600 mb-2">₹1,00,000 - ₹1,50,000</div>
            ...
            {serviceIncludes.map((item, index) => (
              <Card key={index} className="group hover:shadow-lg transition-all duration-300 border-0 shadow-md">
                <CardContent className="p-6 text-center">
                  ...
                  <h3 className="text-lg font-semibold mb-4 group-hover:text-blue-600 transition-colors">
                    {item.title}
                  </h3>
              ...
              <Card key={index} className="border-0 shadow-lg bg-white">
                <CardContent className="p-6">
                  <div className="text-center mb-6">
                    ...
                    <h3 className="text-xl font-semibold text-blue-600">{phase.phase}</h3>
                  </div>
                ...
                <CardContent className="p-6">
                  ...
                  <div className="border-t pt-4">
                    ...
                    <div className="flex justify-between items-center mt-2">
                      <div className="text-sm font-medium text-blue-600">{testimonial.country}</div>
                      <div className="text-sm font-bold text-green-600">{testimonial.value}</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
